...
contract ERC721Contract is ERC721 {
    ...
    function setApprovalForAll(address _operator, bool _approved) external {
        //setting multiple approvers to operate the token
    ...
    function _transfer(
        ...
        // affirming the token to approved address which _to
    ...
    modifier allowTransfer(uint256 _tokenId) {
        //extract the address of owner usign _tokenId
        address owner = ownerOfToken[_tokenId];
        /** msg.sender should be owner
          msg.sender has to approved owner of token
          msg.sender should true operator/ in the operators list
      */
        require(
            owner == msg.sender ||
